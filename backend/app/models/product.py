...
class Product(TimestampMixin, Base):
    ...
    listing_length_cm: Mapped[Decimal | None] = mapped_column(Numeric(10, 2))
    listing_width_cm: Mapped[Decimal | None] = mapped_column(Numeric(10, 2))
    listing_height_cm: Mapped[Decimal | None] = mapped_column(Numeric(10, 2))
